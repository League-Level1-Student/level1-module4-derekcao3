...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Hint: lmao there is no hint");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			JOptionPane.showInputDialog("Ask boii");
			...
			if (rand == 0) {
				JOptionPane.showMessageDialog(null, "yeah lmao");
			}
			...
			if (rand == 3) {
				JOptionPane.showMessageDialog(null, "jacob perez is bad at smash periodt.");
			}
		}
